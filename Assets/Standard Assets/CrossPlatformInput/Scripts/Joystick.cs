...
namespace UnityStandardAssets.CrossPlatformInput
{
	public class Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
	{
		...
		[SerializeField] private int MovementRange = 100;
		...
		//Workaround for the fact these sticks dont actually work (Thanks Unity!)
        ...
        //Reposition the stick after adjusting screen resolution
        public void Refresh() {
	        m_StartPos = transform.position;
        }
